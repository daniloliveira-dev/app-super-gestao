...
@if (isset($produto_detalhe->id))
    <form method="post"
        action="{{ route('produto-detalhe.update', ['produto_detalhe' => $produto_detalhe, 'unidades' => $unidades]) }}">
        @method('PUT')
        @csrf
    @else
...
<button type='submit' class='borda-preta'>Cadastrar detalhe do Produto</button>
</form>
